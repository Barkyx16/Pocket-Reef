  ...
  if (done != null) {
    return (
      <View style={{ alignItems: "center", paddingVertical: space.md }}>
        ...
        <Text style={{ color: "#fff", fontSize: type.bodyLg, fontFamily: "Inter_900Black", fontWeight: "900", marginTop: space.sm }}>
        ...
        <Pressable onPress={() => setDone(null)} style={[styles.ghostBtn, { marginTop: space.md, alignSelf: "stretch" }]} accessibilityRole="button">
  ...
  return (
    <View>
      ...
      <TextInput
        ...
        style={[styles.authInput, { minHeight: 110, marginTop: space.md, textAlignVertical: "top", fontFamily: "Inter_400Regular" }]}
      
            maxLength={TEXT_LIMITS.note}
          />

      {report ? (
        <View style={{ marginTop: space.md, backgroundColor: theme.well, borderRadius: radius.lg, borderWidth: 1, borderColor: report.ok ? "rgba(56,225,198,0.35)" : `${theme.warn}44`, padding: space.md }}>
          ...
          {!report.ok ? (
            <Text style={{ color: theme.bodyText, fontSize: type.small, fontFamily: "Inter_700Bold", fontWeight: "700", lineHeight: 17, marginTop: space.xs }}>{report.reason}</Text>
          ) : null}
      ...
      <Pressable
        ...
        style={[report && report.ok ? styles.primaryBtn : styles.ghostBtn, { marginTop: space.md }]}
