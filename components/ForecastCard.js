          ...
          return (
            <View key={f.key} style={{ flexDirection: "row", gap: 12, alignItems: "flex-start" }}>
              <View style={[styles.iconSquare, { borderColor: `${color}66`, backgroundColor: `${color}1f` }]}>
                <Text style={{ color, fontSize: 15, fontWeight: "900" }}>{arrow}</Text>
              </View>

              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                  <Text style={{ color: "#fff", fontSize: 14, fontWeight: "900" }}>{f.label}</Text>
                  <Text style={{ color: paramStatusColor(f.status), fontSize: 11, fontWeight: "900" }}>
                ...
                {f.daysToEdge != null ? (
                  <Text style={{ color, fontSize: 12, fontWeight: "900", marginTop: 4 }}>
