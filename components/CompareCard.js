...
export function CompareCard({ a, b }) {
  ...
  return (
    <View style={[styles.card, { marginBottom: 0 }]}>
      ...
      {/* Compatibility */}
      <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginTop: 12, backgroundColor: `${compatColor(c.level)}18`, borderRadius: radius.md, borderWidth: 1, borderColor: `${compatColor(c.level)}55`, padding: 12 }}>
