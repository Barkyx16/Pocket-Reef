  ...
  return (
    <View>
      ...
      {DOSABLE.map((key) => {
        ...
        return (
          <View key={key} style={{ marginTop: space.lg, backgroundColor: theme.well, borderRadius: radius.md, borderWidth: 1, borderColor: theme.border, padding: space.md }}>
            ...
            <Text maxFontSizeMultiplier={MAX_FONT_SCALE_COMPACT} style={{ color: rate.ok ? theme.bodyText : theme.secondaryText, fontSize: type.small, fontFamily: "Inter_600SemiBold", fontWeight: "600", marginTop: space.xs, lineHeight: 17 }}>
              {describeConsumption(key, rate)}
            </Text>

            {daily ? (
              <View style={{ flexDirection: "row", alignItems: "center", gap: space.sm, marginTop: space.sm, backgroundColor: "rgba(56,225,198,0.10)", borderRadius: radius.sm, borderWidth: 1, borderColor: "rgba(56,225,198,0.30)", paddingHorizontal: space.md, paddingVertical: space.sm }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: space.sm, marginTop: space.md }}>
              <TextInput
                ...
                style={{ width: 76, backgroundColor: "rgba(255,255,255,0.07)", borderRadius: radius.sm, paddingHorizontal: space.md, paddingVertical: space.sm, color: theme.text, borderWidth: 1, borderColor: theme.border, fontSize: type.body, fontFamily: "Inter_800ExtraBold", fontWeight: "800", textAlign: "center" }}
          ...
          />
              ...
              <Pressable
                ...
                style={({ pressed }) => [{ paddingHorizontal: space.lg, paddingVertical: space.sm, borderRadius: radius.sm, backgroundColor: amounts[key] ? theme.accent : "rgba(255,255,255,0.06)" }, pressed && { opacity: 0.8 }]}
            ...
            {showStrength === key ? (
              <View style={{ marginTop: space.md }}>
                ...
                <TextInput
                  ...
                  placeholderTextColor={theme.secondaryText}
                  style={{ marginTop: space.sm, backgroundColor: "rgba(255,255,255,0.07)", borderRadius: radius.sm, paddingHorizontal: space.md, paddingVertical: space.sm, color: theme.text, borderWidth: 1, borderColor: theme.border, fontSize: type.body, fontFamily: "Inter_800ExtraBold", fontWeight: "800" }}
      ...
      {recent.length ? (
        <View style={{ marginTop: space.lg }}>
          <Text accessibilityRole="header" style={[styles.cardEyebrow, { marginBottom: space.sm }]}>Recent doses</Text>
          <View style={{ gap: space.sm }}>
            {recent.map((d) => (
              <View key={d.id} style={{ flexDirection: "row", alignItems: "center", gap: space.md, backgroundColor: "rgba(255,255,255,0.03)", borderRadius: radius.md, borderWidth: 1, borderColor: theme.hairline, paddingHorizontal: space.md, paddingVertical: space.sm }}>
