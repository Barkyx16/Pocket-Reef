  ...
  return (
    <View style={styles.card}>
      ...
      >
        ...
        <View style={{ width: 30, height: 30, borderRadius: radius.xl, alignItems: "center", justifyContent: "center", backgroundColor: open ? "rgba(56,225,198,0.14)" : "rgba(255,255,255,0.05)", borderWidth: 1, borderColor: open ? "rgba(56,225,198,0.30)" : theme.border, marginLeft: space.md }}>
          <Ionicons name={open ? "chevron-down" : "chevron-forward"} size={16} color={theme.accent} />
        </View>
      </Pressable>
      {open ? <View style={{ marginTop: space.lg }}>{children}</View> : null}
    </View>
  );
});
