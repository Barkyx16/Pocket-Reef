...
export function StabilityCard({ tank = {}, waterType = "fresh", now }) {
  ...
  return (
    <View>
      <View style={{ flexDirection: "row", alignItems: "center", gap: space.md, backgroundColor: `${tone.color}14`, borderRadius: radius.xl, borderWidth: 1, borderColor: `${tone.color}44`, padding: space.lg }}>
      ...
      <Text style={{ color: theme.bodyText, fontSize: type.small, fontFamily: "Inter_700Bold", fontWeight: "700", lineHeight: 18, marginTop: space.md }}>
        ...
        {result.items.map((it) => {
          ...
          return (
            <Pressable
              ...
              style={({ pressed }) => [{ flexDirection: "row", alignItems: "center", gap: space.md, backgroundColor: theme.well, borderRadius: radius.md, borderWidth: 1, borderColor: theme.border, paddingHorizontal: space.md, paddingVertical: space.md }, pressed && { opacity: 0.75, borderColor: t.color }]}
