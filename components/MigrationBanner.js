...
export function MigrationBanner({ onRestore, restoring }) {
  return (
    <View style={{ backgroundColor: "rgba(255,123,123,0.10)", borderRadius: radius.xl, borderWidth: 1, borderColor: "rgba(255,123,123,0.42)", padding: 14, marginBottom: 14 }}>
      ...
      <Pressable
        onPress={onRestore}
        disabled={restoring}
        style={({ pressed }) => [{ marginTop: 12, paddingVertical: 11, borderRadius: radius.md, alignItems: "center", backgroundColor: "rgba(255,123,123,0.16)", borderWidth: 1, borderColor: "rgba(255,123,123,0.5)" }, pressed && { opacity: 0.75 }, restoring && { opacity: 0.6 }]}
