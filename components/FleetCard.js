  ...
  return (
    <View>
        ...
        {fleet.ranked.map((p, i) => {
          ...
          return (
            <Pressable
              ...
              style={({ pressed }) => [{ flexDirection: "row", alignItems: "center", gap: space.md, backgroundColor: on ? "rgba(56,225,198,0.10)" : theme.well, borderRadius: radius.lg, borderWidth: 1, borderColor: on ? theme.accent : alertColor ? `${alertColor}44` : theme.border, padding: space.md }, pressed && { opacity: 0.8 }]}
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: alertColor || theme.secondaryText, fontSize: type.caption, letterSpacing: 0.6, fontFamily: "Inter_700Bold", fontWeight: "700", marginTop: space.hair }}>
      ...
      {fleet.differences.length ? (
        <View style={{ marginTop: space.lg, backgroundColor: theme.well, borderRadius: radius.lg, borderWidth: 1, borderColor: theme.border, padding: space.md }}>
          ...
          <View style={{ flexDirection: "row", marginTop: space.md, marginBottom: space.xs }}>
            <Text style={{ flex: 1 }} />
          ...
          {fleet.differences.slice(0, 4).map((d) => (
            <View key={d.id} style={{ flexDirection: "row", alignItems: "center", paddingVertical: space.xs, borderTopWidth: 1, borderTopColor: theme.hairline }}>
