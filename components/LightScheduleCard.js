  ...
  return (
    <View>
      {!editing && assessment.ok ? (
        <>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: `${tone}14`, borderRadius: 16, borderWidth: 1, borderColor: `${tone}40`, padding: 14 }}>
            <View style={{ alignItems: "center", minWidth: 54 }}>
              ...
              <Text style={{ color: theme.secondaryText, fontSize: 9.5, fontFamily: "Inter_900Black", fontWeight: "900", letterSpacing: 0.6, textTransform: "uppercase" }}>hours</Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={{ color: tone, fontSize: 13.5, fontFamily: "Inter_900Black", fontWeight: "900" }}>
                {assessment.schedule.on} – {assessment.schedule.off} · {assessment.profile.label}
              </Text>
              <Text style={{ color: theme.bodyText, fontSize: 12, fontFamily: "Inter_700Bold", fontWeight: "700", lineHeight: 17, marginTop: 3 }}>{assessment.note}</Text>
            </View>
          </View>
          ...
          {better ? (
            <Pressable
              onPress={() => save(better)}
              style={({ pressed }) => [{ flexDirection: "row", alignItems: "center", gap: 8, marginTop: 12, backgroundColor: "rgba(56,225,198,0.10)", borderRadius: 14, borderWidth: 1, borderColor: "rgba(56,225,198,0.35)", padding: 12 }, pressed && { opacity: 0.8 }]}
            ...
            >
              ...
              <Text style={{ flex: 1, color: theme.bodyText, fontSize: 12.5, fontFamily: "Inter_700Bold", fontWeight: "700", lineHeight: 17 }}>
        ...
        <>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 10, marginTop: 14 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ color: theme.secondaryText, fontSize: 10.5, fontFamily: "Inter_900Black", fontWeight: "900", letterSpacing: 0.6, textTransform: "uppercase", marginBottom: 5 }}>On</Text>
          ...
          />
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: theme.secondaryText, fontSize: 10.5, fontFamily: "Inter_900Black", fontWeight: "900", letterSpacing: 0.6, textTransform: "uppercase", marginBottom: 5 }}>Off</Text>
          ...
          <Text style={{ color: theme.secondaryText, fontSize: 10.5, fontFamily: "Inter_900Black", fontWeight: "900", letterSpacing: 0.6, textTransform: "uppercase", marginTop: 14 }}>What's it lighting?</Text>
          <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 8 }}>
            {PROFILES.map((p) => (
              <Pill key={p.id} label={p.label} active={profile === p.id} onPress={() => { tapHaptic("light"); setProfile(p.id); }} />
            ))}
          </View>
          <Text style={{ color: theme.bodyText, fontSize: 11.5, fontFamily: "Inter_600SemiBold", fontWeight: "600", lineHeight: 16, marginTop: 6 }}>
