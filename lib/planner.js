...
const ROLES = [
  ...
  },
  {
    ...
    why: "Movement and colour. Schooling fish are stressed and washed-out kept in ones and twos.",
  ...
  const items = [
    {
      ...
      detail: lift > 0
        ? `Holds ${target}°F in a ${roomTempF}°F room. Two smaller heaters are safer than one big one — if one sticks on, it can't cook the tank alone.`
        : `Your room already sits at or above ${target}°F. Watch for overheating instead.`,
    },
    {
      id: "filter",
      label: "Filtration",
